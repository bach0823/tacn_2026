...
> 📌 **Tóm tắt:** Webmaster tư vấn, quản lý và phát triển website, đảm bảo tương thích đa nền tảng. Lương trung bình $51,533/năm.
...
> 📌 **Tóm tắt:** Hardware Engineer nghiên cứu, thiết kế và kiểm thử thiết bị máy tính. Lương trung bình cao nhất trong nhóm: $83,631/năm. Biết Verilog sẽ được trả lương cao hơn.
...
> 📌 **Tóm tắt:** Software Engineer viết, chỉnh sửa và debug phần mềm cho khách hàng. Lương trung bình $81,884/năm.
...
> 📌 **Tóm tắt:** Network Administrator cài đặt, bảo trì hệ thống mạng và telecom, đào tạo người dùng. Lương ~$58K/năm, có thưởng và chia lợi nhuận.
...
> 📌 **Tóm tắt:** Chuyên gia bảo mật phân tích yêu cầu, cập nhật cấu hình và tư vấn về kiểm soát truy cập, phục hồi thảm họa. Lương $76,667/năm.

> **[VI]** Phân tích và xác định yêu cầu bảo mật cho mạng cục bộ và diện rộng. Cập nhật cấu hình bảo mật bằng cách xem xét định kỳ các thông báo từ nhà cung cấp. Tái chứng nhận bảo mật ứng dụng, nền tảng và máy chủ định kỳ. Tư vấn kỹ thuật về kiểm soát truy cập, mô hình bảo mật, phục hồi sau thảm họa và đào tạo nhận thức bảo mật.
...
> 📌 **Tóm tắt:** Help Desk Technician cài đặt thiết bị và xử lý sự cố IT. Lương thấp nhất nhóm: $15.94/giờ.
...
> 📌 **Tóm tắt:** DIGITUM-UK tuyển Senior Programmer làm đầy đủ vòng đời phần mềm. Yêu cầu ít nhất 2 năm kinh nghiệm `COBOL`/`C++` và ưu tiên biết ngoại ngữ châu Âu.

> **[VI]** **LẬP TRÌNH VIÊN CAO CẤP** yêu cầu bởi *DIGITUM-UK*, nhà cung cấp hệ thống kinh doanh hàng đầu cho ngành bảo hiểm. Bạn sẽ có thể làm việc trên đầy đủ các hoạt động phát triển phần mềm – phân tích, thiết kế, viết mã, kiểm thử, gỡ lỗi và triển khai. Yêu cầu có ít nhất **hai năm kinh nghiệm** về `COBOL` hoặc `C++`. Vì chúng tôi hoạt động ở Châu Âu, việc thông thạo tiếng Pháp, tiếng Ý hoặc một ngôn ngữ Châu Âu khác là điều đáng mong đợi. Đừng bỏ lỡ cơ hội này để học hỏi các kỹ năng mới và phát triển sự nghiệp của bạn. Gửi CV của bạn tới *Chris Scott*, Trưởng phòng Nhân sự, *DIGITUM-UK*, 75 Đường Parkshill, London SW14 3DE. Bạn có thể truy cập trang web của chúng tôi tại *www.digitum-uk.com*.
...
> 📌 **Tóm tắt:** Tạp chí tài chính tuyển DTP Operator biết `QuarkXPress` với ít nhất 3 năm kinh nghiệm thiết kế dàn trang. Ưu tiên biết `Photoshop`, `Freehand`, `Illustrator`.

> **[VI]** **NHÂN VIÊN XUẤT BẢN ĐIỆN TỬ (DTP)** yêu cầu cho một tạp chí tài chính hàng đầu. Chúng tôi đang tìm kiếm một người vận hành `QuarkXPress` nhanh nhẹn, có năng lực với ít nhất **ba năm kinh nghiệm** trong thiết kế và dàn trang. Kỹ năng về `Photoshop`, `Freehand` hoặc `Illustrator` là một lợi thế. Khả năng làm việc nhóm và làm việc dưới các hạn chót nghiêm ngặt là cực kỳ quan trọng. Vui lòng nộp hồ sơ bằng văn bản, kèm theo CV và các tác phẩm mẫu của bạn, tới *Tom Parker*, Giám đốc Sản xuất, *Financial Monthly*, Đường Stockton, London EC1A 4WW. Hoặc nộp đơn trực tuyến.
...
> 📌 **Tóm tắt:** Sarah Brown xin việc Senior Programmer. Tốt nghiệp 2002, từng thực tập tại British Gas, làm việc tại NCR đến 3/2004, hiện là software engineer tại Intelligent Software được 3 năm. Biết COBOL và C, có kiến thức tiếng Tây Ban Nha và Ý.

> **[VI]** Tôi viết thư này để ứng tuyển vị trí Lập trình viên Cao cấp, được đăng ngày 28 tháng 3 trên tờ *The Times*. Tôi tốt nghiệp tháng 5 năm 2002 và thực tập tại *British Gas* trong khuôn khổ chương trình học. Trước công việc hiện tại, tôi đã làm việc một năm tại *NCR* cho đến tháng 3 năm 2004. Trong ba năm qua, tôi làm kỹ sư phần mềm tại *Intelligent Software*, thiết kế bốn chương trình `COBOL` cho mục đích thương mại và từ tháng 1 đã viết chương trình bằng `C` cho chuỗi bán lẻ lớn. Hai năm trước, tôi dành ba tháng tại Tây Ban Nha để kiểm thử chương trình và nhiều lần đến Italy, nên tôi có kiến thức cơ bản về tiếng Tây Ban Nha và Ý.
...
```mermaid
graph LR
  A[webmaster] --- 1["quản lý, phát triển và tối ưu website"]
  B[hardware engineer] --- 2["nghiên cứu, thiết kế và kiểm thử phần cứng"]
  C[software engineer] --- 3["viết, debug và kiểm thử phần mềm"]
  D[network administrator] --- 4["cài đặt và bảo trì hệ thống mạng"]
  E[computer security specialist] --- 5["phân tích yêu cầu và bảo mật hệ thống"]
  F[help desk technician] --- 6["hỗ trợ kỹ thuật và xử lý sự cố IT"]
```
...
### Exercise E — Job Suitability & Skills Matching (suy luận)
...
### Exercise F — Writing: Letter of Application (suy luận)
