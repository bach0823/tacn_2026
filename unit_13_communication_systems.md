...
> 📌 **Tóm tắt:** Viễn thông là truyền tín hiệu đi xa qua điện thoại, mạng máy tính hay Internet. Viễn thông tạo ra các xu hướng làm việc tại nhà (teleworking), trung tâm hỗ trợ (call centres) và bán hàng qua điện thoại (telemarketing).
...
> 📌 **Tóm tắt:** Truyền hình và phát thanh số có sự nâng cấp vượt bậc so với hệ thống tương tự (analogue): hỗ trợ dịch vụ tương tác, đa phương tiện trả phí, màn hình rộng 16:9, hình ảnh/âm thanh sắc nét hơn. Các chuẩn `DMB`, `DVB-H`, `DAB` giúp truyền nội dung số tới thiết bị di động.
...
> Truyền hình kỹ thuật số mặt đất được tiếp nhận qua một đầu giải mã (set-top box), một thiết bị giải mã tín hiệu nhận được từ ăng-ten. Các công nghệ mới đang được thiết kế để cho phép bạn xem TV trên điện thoại di động của mình. Ví dụ, DMB (Phát sóng đa phương tiện kỹ thuật số) và DVB-H (Phát sóng video kỹ thuật số cho thiết bị cầm tay) có thể gửi đa phương tiện (đài phát thanh, TV và dữ liệu) đến các thiết bị di động.
> Các chương trình âm thanh (âm nhạc, tin tức, thể thao, v.v.) cũng được truyền ở định dạng đài phát thanh kỹ thuật số gọi là DAB (Phát thanh âm thanh kỹ thuật số).
...
> 📌 **Tóm tắt:** Công nghệ không dây kết nối thiết bị di động/BlackBerry với mạng. Định vị vệ tinh `GPS` cực phổ biến. Máy tính đeo trên người (wearable computer) giúp biến đổi người dùng thành các sinh vật cơ khí sinh học (cyborgs).
...
> Việc sử dụng định vị toàn cầu GPS trên ô tô và thiết bị PDA là rất phổ biến, nhờ đó bạn có thể dễ dàng định hướng ở một thành phố xa lạ hoặc tìm trạm xăng gần nhất. Trong vài năm tới, chip GPS sẽ được tích hợp vào hầu hết các điện thoại di động.
> Một xu hướng khác là máy tính đeo trên người (wearable computers). Bạn có thể tưởng tượng mình đeo một chiếc máy tính trên thắt lưng và nhận email trên kính râm không? Một số thiết bị được trang bị modem không dây, bàn phím và màn hình nhỏ; những thiết bị khác được kích hoạt bằng giọng nói.
> Người sử dụng công nghệ đeo trên người đôi khi còn được gọi là "cyborgs". Thuật ngữ này được phát minh bởi Manfred Clynes và Nathan Kline vào năm 1960 to mô tả các thực thể cơ khí sinh học (cybernetic organisms) - những sinh vật nửa robot, nửa con người.
...
```mermaid
graph LR
  A[Fax] --- 1["Gửi và nhận tài liệu sao chép qua mạng điện thoại"]
  B[GPS] --- 2["Hệ thống định vị vị trí địa lý dựa trên vệ tinh"]
  C[Teletext] --- 3["Hiển thị thông tin dạng văn bản tin tức trên màn hình TV"]
  D[Call centre] --- 4["Bộ phận tiếp nhận cuộc gọi chăm sóc hoặc tư vấn từ xa"]
```
...
### Exercise E (Tham khảo học thuật)
...
### Exercise F — Nối thiết bị với chức năng (suy luận)
...
### Exercise G — Mobile phone features (Labelling) (suy luận)
...
### Exercise H — Discussion: Mobile Phone Usage (Tham khảo gợi ý trả lời)
...
### Exercise I — Brainstorming: Future Technologies (Gợi ý ghi chú)
1. **Nanotechnology:**
