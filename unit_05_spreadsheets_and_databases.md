...
> 📌 **Tóm tắt:** Trang tính (worksheet) là tập hợp các ô trên một lớp tệp tin. Bảng tính (spreadsheet) chỉ chương trình hoặc bảng hiển thị số liệu hàng/cột. Thay đổi giá trị ở một ô sẽ khiến toàn bộ bảng tính tự động tính toán lại.
...
> 📌 **Tóm tắt:** Thư gửi khách hàng xác nhận đã gửi đơn hàng gồm 4 PC để bàn kèm màn hình, 2 laptop, máy in laser, cơ sở dữ liệu D5 và phần mềm diệt virus. Người gửi đính kèm hóa đơn và yêu cầu thanh toán qua Internet hoặc séc.

> **[VI]** **Kính gửi cô Atkinson**,
> Tôi viết thư này để xác nhận rằng chúng tôi đã gửi cho cô bốn máy tính để bàn kèm màn hình, hai máy tính xách tay và một máy in laser, cùng với một cơ sở dữ liệu D5 và một chương trình chống virus cho mỗi máy tính. Vui lòng đợi hai tuần để giao hàng.
> Tôi xin đính kèm hai bản sao **hóa đơn** của cô.
> Chúng tôi sẽ rất biết ơn nếu cô có thể thanh toán bằng séc hoặc chuyển khoản trực tiếp vào tài khoản ngân hàng của chúng tôi qua Internet.
> Chúng tôi cũng rất vui mừng được thông tin đến cô rằng chúng tôi đang cung cấp cho khách hàng một khóa học trực tuyến miễn phí có tên là *Văn phòng không giấy tờ*. Vui lòng liên hệ với chúng tôi nếu cô cần thêm bất kỳ thông tin nào.
> **Trân trọng**,
> *Ian Pegg*
...
> 📌 **Tóm tắt:** Hệ quản trị cơ sở dữ liệu (DBMS) lưu trữ, tổ chức dữ liệu. Thông tin đi qua các trường (fields), nhóm thành bản ghi (records), tạo nên tệp (files). Các tệp tin được liên kết dạng quan hệ (relational) qua trường khóa (key field).
