...
> 📌 **Tóm tắt:** Hộp công cụ đồ họa chứa các primitives (hình cơ bản) kèm attributes (thuộc tính màu/viền). Người dùng có thể biến đổi vật thể bằng các phép: dịch chuyển (translation), xoay (rotation) và co giãn tỉ lệ (scaling).
