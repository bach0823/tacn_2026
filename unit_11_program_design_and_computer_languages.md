...
>
> 📌 *Tóm tắt:* Máy tính chỉ hiểu trực tiếp mã máy (machine code) gồm các số 0 và 1.
...
> **[VI]** - *FORTRAN* được phát triển bởi `IBM` vào năm 1954 và vẫn được sử dụng cho các ứng dụng khoa học và kỹ thuật.
>
> 📌 *Tóm tắt:* 

- *COBOL* (Common Business Oriented Language) was developed in 1959 and is mainly used for business applications.

> **[VI]** - *COBOL* (Ngôn ngữ hướng kinh doanh chung) được phát triển vào năm 1959 và chủ yếu được sử dụng cho các ứng dụng kinh doanh.
>
> 📌 *Tóm tắt:* 
...
> **[VI]** - *BASIC* được phát triển vào những năm 1960 và được sử dụng rộng rãi trong lập trình máy vi tính vì nó dễ học. *Visual BASIC* là một phiên bản hiện đại của ngôn ngữ *BASIC* cũ, được sử dụng để xây dựng các yếu tố đồ họa như nút bấm và cửa sổ trong các chương trình Windows.
>
> 📌 *Tóm tắt:* 

- *PASCAL* was created in 1971. It is used in universities to teach the fundamentals of programming.

> **[VI]** - *PASCAL* được tạo ra vào năm 1971. Nó được sử dụng trong các trường đại học để giảng dạy các nguyên lý cơ bản của lập trình.
>
> 📌 *Tóm tắt:*
...
>
> 📌 *Tóm tắt:* Ngôn ngữ *C* chuyên viết phần mềm hệ thống và đồ họa. *C++* tích hợp lập trình hướng đối tượng (`OOP`) giúp dễ dàng chỉnh sửa chương trình.
...
>
> 📌 *Tóm tắt:* *Java* chuyên chạy trên Web. Các chương trình bậc cao được dịch sang mã máy bằng trình biên dịch (compiler - dịch toàn bộ một lúc) hoặc trình thông dịch (interpreter - dịch từng dòng khi chạy).
...
>
> 📌 *Tóm tắt:* Cần phân biệt ngôn ngữ lập trình với ngôn ngữ đánh dấu (markup languages) vốn sử dụng thẻ (tags) để định dạng và liên kết văn bản.

- *HTML*, which allows us to describe how information will be displayed on web pages.

> **[VI]** - *HTML*, cho phép chúng ta mô tả cách thông tin sẽ hiển thị trên các trang web.
>
> 📌 *Tóm tắt:* Các ngôn ngữ đánh dấu gồm *HTML* (hiển thị trang web), *XML* (thẻ tự định nghĩa) và *VoiceXML* (truy cập web bằng giọng nói qua điện thoại).
...
> **[VI]** - *XML*, viết tắt của Ngôn ngữ đánh dấu mở rộng. ⚠️ Trong khi *HTML* sử dụng các thẻ được định nghĩa sẵn, *XML* cho phép chúng ta tự định nghĩa các thẻ của riêng mình; nó không bị giới hạn bởi một tập hợp thẻ cố định.
>
> 📌 *Tóm tắt:* 
...
> **[VI]** - *VoiceXML*, giúp làm cho nội dung Web có thể truy cập được thông qua giọng nói và điện thoại. *VoiceXML* được sử dụng để tạo các ứng dụng giọng nói chạy trên điện thoại, trong khi *HTML* được sử dụng để tạo các ứng dụng hiển thị trực quan (ví dụ: các trang web).
>
> 📌 *Tóm tắt:*
...
>
> 📌 *Tóm tắt:* *Visual BASIC* (1990) của *Microsoft* giúp lập trình nhanh giao diện đồ họa (`GUI`) trên Windows nhờ kéo thả đối tượng có sẵn.
...
**Câu 2 (Điền từ):** The programming languages C and PASCAL are classified as ____________ languages because they are closer to English than machine code.
...
**Câu 4 (Điền từ):** Fill in the blank with the correct form of the verb in brackets: "Visual BASIC is easy ________ (learn)."
...
**Câu 5 (Điền từ):** What does `OOP` stand for in programming? _____________.
