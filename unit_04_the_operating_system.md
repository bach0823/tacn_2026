...
> 📌 **Tóm tắt:** Phần mềm được chia làm hai loại: phần mềm hệ thống (điều khiển hoạt động cơ bản như OS, driver) và phần mềm ứng dụng (thực hiện tác vụ cụ thể như Office, game). OS quản lý tài nguyên phần cứng và phần mềm của máy tính.
...
> - **Phần mềm hệ thống** (system software), bao gồm tất cả các chương trình kiểm soát các chức năng cơ bản của máy tính (ví dụ: hệ điều hành, phần mềm lập trình, trình điều khiển thiết bị và tiện ích).
> - **Phần mềm ứng dụng** (applications software), bao gồm các chương trình cho phép bạn thực hiện các tác vụ cụ thể. Các ứng dụng điển hình bao gồm xử lý văn bản, cơ sở dữ liệu, chương trình giáo dục, email và trò chơi video.
> **Hệ điều hành** (OS) là một tập hợp các chương trình kiểm soát tài nguyên phần cứng và phần mềm của một hệ thống máy tính. Các chức năng điển hình bao gồm xử lý các hoạt động đầu vào/đầu ra, chạy các chương trình và tổ chức các tệp tin trên đĩa.
...
> 📌 **Tóm tắt:** Giao diện đồ họa (GUI) ra đời năm 1984 với Mac của Apple thay thế giao diện dòng lệnh phức tạp. GUI dùng môi trường WIMP (cửa sổ, biểu tượng, menu, con trỏ) giúp máy tính thân thiện và dễ tiếp cận hơn, hỗ trợ đa nhiệm (multitasking).
