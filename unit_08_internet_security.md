...
> **[VI]** 
> - **Vi phạm bản quyền (Piracy)**: sao chép và phân phối bất hợp pháp phần mềm, trò chơi hoặc các tệp nhạc có bản quyền.
> - **Đạo văn và trộm cắp sở hữu trí tuệ (Plagiarism)**: giả vờ rằng tác phẩm của người khác là của riêng mình.
> - **Phát tán phần mềm độc hại**: phân phối các chương trình được thiết kế để gây hại cho hệ thống máy tính.
> - **Giả mạo lừa đảo (Phishing)**: lấy mật khẩu tài khoản ngân hàng trực tuyến hoặc số thẻ tín dụng bằng cách sử dụng các email trông giống như từ các tổ chức thực tế, nhưng thực chất là giả mạo.
> - **Giả mạo IP (IP spoofing)**: làm cho một máy tính trông giống như một máy tính khác nhằm giành quyền truy cập trái phép.
> - **Quấy rối mạng (Cyberstalking)**: quấy rối hoặc lạm dụng trực tuyến, chủ yếu trong các phòng trò chuyện hoặc nhóm tin.
> - **Phát tán tài liệu đồi trụy hoặc xúc phạm**: lan truyền các nội dung bất hợp pháp hoặc không phù hợp.
...
> 📌 **Tóm tắt:** Internet là hệ thống mở nên tiềm ẩn nhiều nguy cơ. Bảo mật web cần tắt cookies, kiểm tra biểu tượng khóa SSL và dùng chứng thư số. Email cần được mã hóa bằng PGP. Mạng doanh nghiệp được bảo vệ bằng mật khẩu, tường lửa (firewalls) và mã hóa dữ liệu.
...
> **[VI]** 
> - **1969**: Bộ Quốc phòng Mỹ thiết lập mạng `ARPANET`, kết nối các trung tâm nghiên cứu.
> - **1971**: *John Draper* phát hiện tiếng còi đồ chơi Cap'n Crunch phát ra tần số 2.600Hz trùng khớp tín hiệu AT&T để gọi điện miễn phí. *Ray Tomlinson* phát minh ra chương trình email đầu tiên.
> - **1974**: *Kevin Mitnick* hack mạng ngân hàng. Vụ hack NADC của ông sau này truyền cảm hứng cho bộ phim *War Games* năm 1983.
> - **1981**: *Ian Murphy* (Captain Zap) đột nhập vào Nhà Trắng và Lầu Năm Góc.
> - **1988**: *Nicholas Whitely* bị bắt vì phát tán virus. Ngân hàng Thụy Sĩ suýt mất 32 triệu bảng. Giao thức `TCP/IP` được chọn làm chuẩn chung của Internet.
> - **1989**: Cậu bé 15 tuổi hack thành công máy tính quân sự Mỹ.
> - **1991**: *Kevin Poulsen* (Dark Dante) đánh cắp hồ sơ quân sự. `CERN` tạo ra mạng lưới World Wide Web.
> - **1992**: *David L. Smith* **bị** truy tố vì viết virus Melissa lây qua tệp Word.
> - **1997**: Câu lạc bộ Chaos Computer (Đức) **trình chiếu** trên TV cách trộm tiền từ tài khoản.
> - **2000**: Tin tặc Nga **tống tiền** CD Universe. Tin tặc Canada **khởi chạy** tấn công từ chối dịch vụ. Virus *ILoveYou* **phát tán** cực nhanh và **ghi đè** các tệp tin.
> - **2001**: Sâu *Code Red* **lây nhiễm** hàng vạn máy tính. Mạng chia sẻ nhạc *Napster* bị tòa tuyên vi phạm bản quyền.
