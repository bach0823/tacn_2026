# UNIT 06 — The Internet and Email
...
### BẢNG TỔNG HỢP — CÁC DỊCH VỤ INTERNET CHÍNH

⚠️ Bảng này là nguồn ôn chính cho dạng bài "phân biệt chức năng các dịch vụ Internet" và "nối dịch vụ với tác vụ".

| Dịch vụ Internet | Giao thức / Phần mềm | Tác vụ / Chức năng chính |
|---|---|---|
| **Email** | POP3, IMAP, SMTP / Outlook | Gửi và nhận thư điện tử kèm tệp đính kèm (attachments). |
| **The Web (WWW)** | HTTP / Chrome, Firefox, Safari | Tìm kiếm, xem và in ấn các tài liệu siêu văn bản (web pages). |
| **Chat & IM** | IRC, XMPP / Messenger, Skype | Trò chuyện trực tuyến bằng văn bản theo thời gian thực (real-time). |
| **FTP** | File Transfer Protocol | Truyền tải tệp tin (upload/download) giữa máy nội bộ và máy chủ từ xa. |
| **Telnet** | Telnet Protocol | Đăng nhập và điều khiển, chạy chương trình trên máy tính từ xa qua dòng lệnh. |
| **Newsgroups** | NNTP / Newsreader | Tham gia thảo luận công cộng theo các chủ đề (message threads) trên Usenet. |

---

## 2. BÀI ĐỌC SONG NGỮ (Reading — EN | VI)

### Internet FAQs: Part 1 — History & Connection
...
Trong tiếng Anh, câu hỏi được chia làm hai loại chính: Câu hỏi Có/Không (Yes/No questions) và Câu hỏi có từ để hỏi (Wh- questions).

#### 3.1 Câu hỏi Có/Không (Yes/No Questions)
Được thành lập bằng cách đảo Trợ động từ (*Auxiliary Verbs*: *be, have, will, can...*) hoặc trợ động từ *do/does/did* lên trước chủ ngữ.
$$\text{Trợ động từ} + \text{S} + \text{V (nguyên thể)} ... ?$$
- *Ví dụ với Be:* **Are** there other ways of accessing the Internet?
- *Ví dụ với Did (quá khứ đơn):* **Did** the Internet become popular quickly?
- *Ví dụ với Can:* **Can** you use Wi-Fi here?

#### 3.2 Câu hỏi có từ để hỏi (Wh- Questions)
Dùng để khai thác thông tin chi tiết. Từ để hỏi đứng đầu câu, theo sau là trợ động từ và chủ ngữ.
$$\text{Từ để hỏi (Wh-)} + \text{Trợ động từ} + \text{S} + \text{V} ... ?$$

Các từ để hỏi phổ biến trong ngành IT:
- **Who (Ai - người):** *Who* created the Internet?
- **What (Cái gì - vật/định nghĩa):** *What* does TCP/IP mean?
- **Which (Cái nào - lựa chọn giới hạn):** *Which* email program is the best?
- **Where (Ở đâu - nơi chốn):** *Where* can you find newsgroups?
- **When (Khi nào - mốc thời gian):** *When* was it created?
- **Why (Tại sao - lý do):** *Why* do you need a modem?
- **How (Như thế nào - cách thức/phương tiện):** *How* do you get online?
- **How long (Bao lâu - khoảng thời gian):** *How long* has broadband existed?
- **How often (Tần suất bao lâu một lần):** *How often* are web pages updated?
- **How much (Bao nhiêu - danh từ không đếm được / giá tiền):** *How much* does broadband cost?
- **How many (Bao nhiêu - danh từ đếm được số nhiều):** *How many* active newsgroups are there?
- **How fast (Tốc độ bao nhiêu):** *How fast* are today's connections?
...
1. Q: __________________________________________________
   A: I'm 23 years old.
2. Q: __________________________________________________
   A: I'm an online researcher.
3. Q: __________________________________________________
   A: I use the Internet to find information requested by clients.
4. Q: __________________________________________________
...
- A (1) ________________ and a (2) ________________.
- Also need an account with an (3) ________________ (ISP) - a company that offers connection for a monthly fee.
- If you want to connect lots of computers without using cables, you can use a (4) ________________ router.
- Wi-Fi uses (5) ________________ waves to send data over medium-range distances.
...
5. **The standard protocol that allows computers to communicate over the Internet is called**
   ...
   - b. TCP/IP.
   - c. HTTP.
6. **The geographical region covered by one or several wireless access points is called a**
...
3. To connect to a remote computer system by typing credentials: l________________
...
3. The part of the email address that identifies the specific user.
4. The header line that describes the topic of the email.
5. A computer file sent along with an email message.
6. Symbols (like `:-o`) used to express feelings in a message.
7. Unsolicited junk email messages.
...
4. **Subject** — Dòng chủ đề hiển thị khái quát nội dung email.
5. **attachment** — Tệp đính kèm gửi kèm thư.
...
*   **2-A** (Bcc — Bản sao ẩn danh)
*   **3-B** (To — Người nhận chính của thư điện tử)
